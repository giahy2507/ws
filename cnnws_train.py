...
if __name__ == "__main__":
    ...
    with open("../data/vcl.pre.txt.train.pickle", mode="rb") as f:
    ...
    sys.stdout.write(str(X_train.shape)+ str(Y_train.shape) + str(X_validation.shape) + str(Y_validation.shape) + "\n")
    sys.stdout.flush()
    ...
    while counter < early_stop:
        ...
        if best_valid_err > val_err:
            ...
            sys.stdout.write("Epoch "+str(epoch_i)+" Train cost: "+ str(train_cost)+ "Train err: "+ str(train_err) + "Time: " + str(end_train - start_train) + " Validation cost: "+ str(val_cost)+" Validation err "+ str(val_err) + ",counter "+str(counter)+ " __best__ \n")
            sys.stdout.flush()
            counter = 0
            ...
            counter +=1
            sys.stdout.write("Epoch "+str(epoch_i)+" Train cost: "+ str(train_cost)+ "Train err: "+ str(train_err) + "Time: " + str(end_train - start_train) + " Validation cost: "+ str(val_cost)+" Validation err "+ str(val_err) + ",counter "+str(counter)+ "\n")
            sys.stdout.flush()
